#
# $Id: IPv6.pm,v 1.2 2006/12/16 13:56:25 gomor Exp $
#
package Net::Frame::IPv6;
use strict;
use warnings;
...
Net::Frame::IPv6 - Internet Protocol v6 layer object
...
=head1 SYNOPSIS
   ...
   # Read a raw layer
   my $layer = Net::Frame::IPv6->new(raw = $raw);
...
Load them: use Net::Frame::IPv6 qw(:consts);
